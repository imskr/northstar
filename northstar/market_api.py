...
def market():
    ...
    data: dict[str, dict] = {}
    errors: dict[str, str] = {}
    # Two workers deliberately protect the upstream provider from burst traffic.
    ...
    if not data:
        return jsonify({"error": "Selected prices could not be refreshed.", "errors": errors}), 503
